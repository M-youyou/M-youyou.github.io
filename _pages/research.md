...
Our research consists of the following topics with selected publications: [[View by year](https://ywzhang.cn/publications/)] [[Google scholar](https://scholar.google.com/citations?user=hBZ_tKsAAAAJ)]
...
- **[ACMMM'18, 500+ citations]** [Visual domain adaptation with manifold embedded distribution alignment](https://ywzhang.cn/assets/files/a11_mm18.pdf). Jindong Wang, Wenjie Feng, Yiqiang Chen, Han Yu, Meiyu Huang, and Philip S Yu.
...
- **[ICSE'22]** [ReMoS: Reducing Defect Inheritance in Transfer Learning via Relevant Model Slicing](https://ywzhang.cn/assets/files/icse22-remos.pdf). Ziqi Zhang, Yuanchun Li, Jindong Wang, Bingyan Liu, Ding Li, Xiangqun Chen, Yao Guo, and Yunxin Liu.
- **[IEEE Data Engineering Bulletin'23]** FedCLIP: Fast Generalization and Personalization for CLIP in Federated Learning. Wang Lu, Xixu Hu, Jindong Wang, Xing Xie. [[arxiv](https://arxiv.org/abs/2302.13485)]
